    ...
    <div className="min-h-screen h-auto flex flex-col sm:px-18 bg-[#EFEBE7] font-lexend">
      ...
      <div className="h-auto flex overflow-x-auto whitespace-nowrap hide-scrollbar mt-10 gap-16">
        {cardsData.map((card, index) => (
          <div key={index} className="card w-[550px] h-[600px] flex-shrink-0 rounded-2xl flex flex-col bg-white">
            <div
            ...
            <div className="h-2/5 w-full flex flex-row justify-center flex-wrap gap-4 p-4">
              {Object.entries(card.details).map(([key, value], index) => (
                <div key={index} className="h-auto w-[130px] rounded-lg bg-[#F5f5f5] border border-[#EDECEC] flex flex-col px-2 py-2">

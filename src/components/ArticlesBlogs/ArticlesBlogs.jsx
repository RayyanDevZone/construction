const ArticlesBlogs = () => {
  return (
    <div className="min-h-screen h-auto w-full flex flex-col sm:px-12 px-4 py-16 bg-[#F5F3F2] font-lexend">
      <div className="w-full min-h-[120px] border-b-1 border-b-[#EBE4E0] flex sm:flex-row flex-col justify-between sm:items-center items-start">
        <div>
          <p className="uppercase text-[#f84e1d] font-bold">
            {" "}
            services we provide
          </p>
          <p className="uppercase text-[#141416] sm:text-5xl text-2xl mb-8 mt-4 font-bold">
            Articles & Blog Posts
          </p>{" "}
        </div>
      ...
      <div className="w-full sm:mx-5 flex flex-col px-4 py-5 sm:min-h-[800px] items-center  bg-white rounded-xl mt-16 ">
        ...
        <div className="w-full border-t-1 border-[#EBE4E0] h-[200px] flex flex-row items-center ">
          <div className="h-full sm:flex hidden flex-col sm:pl-5 font-bold justify-center w-[150px] border-r-1 border-[#EBE4E0]">
            <img
          ...
          <div className="flex flex-col sm:px-5 py-7">
            ...
            <p className="sm:text-2xl font-bold text-[#1d1d1f] mt-5 uppercase hover:text-[#f84e1d] cursor-pointer">
